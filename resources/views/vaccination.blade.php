...
<section class="flex flex-col items-center my-12">
    ...
    <div class="w-full md:w-5/6 h-12 flex items-center mb-5 rounded border-2 border-purple-300 justify-between">
        <input type="text" id="search-vaccination" class="w-full focus:outline-none ml-2"
            placeholder="Cari Lokasi Vaksinasi...">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 cursor-pointer" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
...
<section class="flex flex-col-reverse justify-around bg-purple-50 py-16 mb-12 md:flex-row items-center">
    <div class="md:w-3/6 flex flex-col justify-center text-justify py-5 px-8">
        ...
        <div class="">
            <p>Dirangkum dari laman World Health Organization (WHO), vaksin mengandung antigen yang sama dengan antigen
                yang menyebabkan penyakit. </p>
            <br>
            <p>Namun antigen yang ada di dalam vaksin tersebut sudah dikendalikan (dilemahkan) sehingga pemberian vaksin
                tidak menyebabkan orang menderita penyakit seperti jika orang tersebut terpapar dengan antigen yang sama
                secara alamiah.</p>
            <br>
...
<section class="flex justify-around items-center flex-col md:flex-row px-8 md:px-28 bg-blue-50 py-16 mb-12">
    ...
    <div class="md:w-3/6 flex flex-col justify-center text-justify py-5">
        ...
        <p class="md:text-lg">Melalui vaksin, tubuh akan terlindungi dengan cara membentuk respons antibodi tanpa harus
            sakit terlebih dahulu. Artinya, vaksin COVID-19 mampu melindungi tubuh seseorang dari infeksi virus corona.
            Tidak hanya itu, jika kamu terinfeksi virus penyebab COVID-19, vaksin bisa membantu mencegah tubuhmu dari
            sakit parah atau potensi munculnya komplikasi serius.</p>
    </div>
</section>
...
<section class="flex flex-col items-center mx-2 content-between">
    ...
    <div class="flex flex-col md:flex-row  justify-between">
        <div
            class="bg-white my-1 flex-1 flex flex-col items-center hover:bg-green-300 rounded-md border-green-300 border-2 cursor-pointer mx-5">
            <div class="">
            ...
            <div class="p-8">
                ...
                <div>
                    AstraZeneca menggunakan virus adeno hidup (adenovirus) yang telah dimodifikasi sebagai 'pengirim'
                    protein khusus. Protein tersebut akan menginstruksikan sel tubuh untuk memproduksi sebagian kecil
        ...
        <div
            class="bg-white my-1 flex-1 flex flex-col items-center hover:bg-red-300 rounded-md border-red-300 border-2 cursor-pointer mx-5">
            <div class="">
            ...
            <div class=" p-8">
                ...
                <div>
                    Sinovac memanfaatkan virus SARS-COV-2 yang telah dimatikan (inactivated) untuk memicu respons imun.
                    Metode ini sudah terbukti manjur dan telah digunakan dalam pengembangan vaksin lain, seperti vaksin
        ...
        <div
            class="bg-white my-1 flex-1 flex flex-col items-center hover:bg-purple-300 rounded-md border-purple-300 border-2 cursor-pointer mx-5">
            <div class="">
