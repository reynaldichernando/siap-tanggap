...
@section('content')
    ...
    <div id='features' class='text-center w-full bg-yellow-200 flex flex-col space-y-4 py-8 '>
        <div class='text-4xl font-semibold'>
          <h2>Features</h2>
        </div>
        <div class='flex flex-col md:flex-row md:space-x-4 justify-center px-52 font-semibold text-center'>
            <div class='flex-1 border-2 border-dashed border-transparent hover:border-gray-400 cursor-pointer py-2 rounded-xl'>
