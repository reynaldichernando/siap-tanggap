...
<section class="flex flex-col-reverse justify-around bg-blue-50 md:flex-row">
    ...
    <div class="md:w-2/5">
        <div class="">
            <img src="https://png.pngtree.com/png-vector/20200317/ourlarge/pngtree-covid-19-coronavirus-wuhan-vector-illustration-png-image_2162376.jpg"
                alt="" class="">
        </div>
    </div>
</section>
...
<section class="flex justify-around flex-col md:flex-row px-8 md:px-28 bg-blue-50 py-4 mb-12">
    <div class="md:w-2/5">
        <img src="https://image.freepik.com/free-vector/portrait-woman-get-sick-she-is-coughing-suffering-from-chest-pain-coronavirus-2019-ncov-flu-health-medical-illustration_253263-32.jpg   "
            alt="">
    </div>
...
<section class="max-h-80 border-gray-200 flex overflow-x-auto overflow-y-hidden mx-auto w-5/6 no-scrollbar pb-1"
    id="section-news">
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover"
                src="https://cdn1-production-images-kly.akamaized.net/4bvbAuZWibTVBWEqqdb8o3NLZX0=/640x360/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3499878/original/044370100_1625281607-1280X720.jpg"
                alt="">
        </div>
    ...
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover"
                src="https://images2.minutemediacdn.com/image/upload/c_fill,w_912,h_516,f_auto,q_auto,g_auto/shape/cover/sport/5c4b4fc02e4e3c90fa000001.jpeg"
                alt="">
        </div>
        <div class="p-1 text-sm overflow-hidden">
            Berita Virus Corona COVID-19 Hari Ini - Kabar Terbaru Terkini | Liputan6.com
    ...
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover"
                src="https://images2.minutemediacdn.com/image/upload/c_fill,w_912,h_516,f_auto,q_auto,g_auto/shape/cover/sport/5c4b4f58545610dfc8000001.jpeg"
                alt="">
        </div>
        <div class="p-1 text-sm overflow-hidden">
            Berita Virus Corona COVID-19 Hari Ini - Kabar Terbaru Terkini | Liputan6.com
    ...
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover" src="https://cdn.cloudflare.steamstatic.com/apps/dota2/images/dota2_social.jpg"
                alt="">
        </div>
        <div class="p-1 text-sm overflow-hidden">
            Berita Virus Corona COVID-19 Hari Ini - Kabar Terbaru Terkini | Liputan6.com
    ...
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover"
                src="https://cdns.klimg.com/merdeka.com/i/w/news/2021/06/24/1322429/540x270/lampu-merah-kematian-anak-indonesia-karena-covid-19-rev-1.jpg"
                alt="">
        </div>
        <div class="p-1 text-sm overflow-hidden">
            Berita Virus Corona COVID-19 Hari Ini - Kabar Terbaru Terkini | Liputan6.com
    ...
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover"
                src="https://assets.pikiran-rakyat.com/crop/0x0:0x0/360x192/webp/photo/2021/02/09/2671496043.jpg?v=202107"
                alt="">
        </div>
        <div class="p-1 text-sm overflow-hidden">
            Berita Virus Corona COVID-19 Hari Ini - Kabar Terbaru Terkini | Liputan6.com
    ...
    <a href="#" class="news-card w-24 h-52 text-left bg-gray-100 mx-1 shadow-md flex flex-col">
        <div class="">
            <img class="object-cover"
                src="https://cdn.antaranews.com/cache/800x533/2021/04/13/WhatsApp-Image-2021-04-13-at-04.02.21.jpeg"
                alt="">
        </div>
        <div class="p-1 text-sm overflow-hidden">
            Berita Virus Corona COVID-19 Hari Ini - Kabar Terbaru Terkini | Liputan6.com
